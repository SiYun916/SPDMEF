...
### Funcitions
1. DoLinearAddAndMean(): N images each pixed add respectively then divide by N
2. DoMertensMEF(): exposure fusion implementation
3. DoSPDMEF(): SPD-MEF implementation
4. GetImagesMat(): read images
5. GetImagesGrayMat(): convert color images to gray images, maybe you should change this
6. AdjustImageSize(): addjust images size
7. MatchHistograms(): c++ implementation of matchHistograms function in skimage
